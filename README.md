...
node test/math_audit.mjs  # sweeps 6,000+ generated problems: sqrt/equality claims, choice integrity, exact geometry
...
| Legacy modules | `modules/*.js` | The 13 classic missions from the original app, plus two new G1 missions built from the study book (Rational Numbers & Number Line, Add & Subtract Rationals), loaded through the adapter into the new shell. |
