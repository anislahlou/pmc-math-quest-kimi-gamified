...
ok(Array.isArray(M) && M.length === 17, `manifest should list 17 missions, got ${M && M.length}`);
...
ok(legacyFiles.length === 15, `expected 15 legacy module files, found ${legacyFiles.length}`);
